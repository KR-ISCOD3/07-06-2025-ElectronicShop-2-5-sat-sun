...
function Header() {
  ...
  return (
    <nav>
            ...
            <div className='container flex mx-auto  justify-between text-white'>
                ...
                <div className="">               
                    ...
                    <select name="" id="" className='outline-0  '>
                        ...
                        <option value=""  className='text-black'>Japan</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div className=' py-4 px-3 lg:px-0 shadow-lg'>
            <div className="container flex mx-auto  justify-between">
                ...
                <div className='hidden lg:w-[60%] lg:flex items-center justify-between '>
                    ...
                    <form action="" className='flex items-center border border-gray-300 rounded-full p-2 pe-3'>
                        <input placeholder='Search...' className=' border-0 outline-0 px-3' type="text" name="" id="" />
                        <button>
                            <IoSearch/>
                        </button>
                    </form>
        ...
        <div className={` ${isOpen ? 'opacity-100 translate-y-2  pointer-events-auto' : 'opacity-0 -translate-y-4 pointer-events-none'} 
            duration-700
            w-[90%] lg:hidden 
            bg-white border 
            ...
            <form action="" className='flex items-center border border-gray-300 rounded-full p-2 pe-3 mt-5'>
                <input placeholder='Search...' className='w-full border-0 outline-0 px-3' type="text" name="" id="" />
                <button>
                    <IoSearch/>
                </button>
            </form>
